...
file_path <- "data/raw_data/lex_data/"
...
file_names <- list.files("data/raw_data/lex_complaints")
...
filtered_texts <- text_documents %>%
  ...
  mutate(
    file_path = file.path("data/raw_data/lex_complaints", file_names),
...
dir.create("data/overview_data", showWarnings = FALSE)

write_csv(filtered_cases, "data/overview_data/filtered_cases.csv")
write_csv(text_documents, "data/overview_data/text_documents.csv")
write_csv(pdf_documents, "data/overview_data/pdf_documents.csv")
write_csv(filtered_texts, "data/overview_data/filtered_texts.csv")